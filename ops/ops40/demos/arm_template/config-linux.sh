...
sudo wget https://raw.githubusercontent.com/neilpeterson/tailwind-reference-deployment-sandbox/master/deployment-artifacts-standalone-vm/default -O /etc/nginx/sites-available/default
sudo nginx -t
sudo nginx -s reload
...
sudo wget https://raw.githubusercontent.com/neilpeterson/tailwind-reference-deployment-sandbox/master/deployment-artifacts-standalone-vm/tailwind.conf -O /etc/supervisor/conf.d/tailwind.conf
